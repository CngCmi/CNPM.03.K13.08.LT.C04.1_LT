...
<head>
    ...
    <title>Quản Lý Người Dùng - Cửa Hàng 3M</title>
...
<body class="min-h-screen flex flex-col">
    ...
    <main class="flex-grow mx-4 py-8">
        <h2 class="text-2xl font-semibold text-center mb-6">Quản Lý Người Dùng</h2>
                ...
                <tbody>
                    <?php foreach ($users as $user): ?>
                        <tr>
                            ...
                            <td class="p-2 border"><?php echo htmlspecialchars($user['role']); ?></td>
                            <td class="p-2 border">
                                <a href="manage_users.php?delete=<?php echo $user['user_id']; ?>" class="text-red-600 hover:underline" onclick="return confirm('Bạn có chắc chắn muốn xóa người dùng này?')">Xóa</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
